...
bool collector( double x, double y, double z )
{
    return (z>=(depth-10e-6));
}
...
void simu( int argc, char **argv )
{
    ...
    Solid *col = new FuncSolid( collector );
    geom.set_solid( 11, col );
    ...
    geom.set_boundary( 11,  Bound(BOUND_DIRICHLET,  Vsec) );
    geom.set_boundary( 10,  Bound(BOUND_DIRICHLET,  Vcol) );
